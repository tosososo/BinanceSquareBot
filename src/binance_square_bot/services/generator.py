...
- 🎯 开篇要用**反差/悬念钩子**抓住眼球：比如 "所有人都看错了这条新闻..."、"这条新闻的真正含义，90%的人都没看懂..."
- 先用一句话概括新闻核心内容
- 给出你的**独家解读**，挖掘新闻背后的**深层逻辑和潜在影响**，不要简单复述
- 分析这条新闻可能带来的**短期和长期市场变化**
- 提出一个**有争议性的观点**，并用数据或逻辑支撑
- 💬 结尾用开放式问题引导深度讨论，鼓励用户分享你的看法

保持专业但不晦涩，语言流畅自然，分段清晰，每段不超过3行。
